    ...
    <head>
        ...
        <body>
            ...
            <div class="container" id="tamanhoContainer" style="margin-top: 50px">
                ...
                <form action="inserir_categoria.php" method="post" style="margin-top:20px">
                
                    <div class="form-group">
                        <label>Nome da categoria</label>
                        <input type="text" class="form-control" name="nomecategoria" placeholder="Insira o nome da categoria" required>
                    </div>
